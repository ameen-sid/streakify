	...
	return `<!DOCTYPE html>
			<html lang="en">
				<head>
					...
					<title>Your Account Has Been Recovered</title>
					<style>
						/* Basic Resets */
											...
											<table border="0" cellpadding="0" cellspacing="0" width="100%">
												...
												<tr>
													<td align="center" style="padding-bottom: 20px; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; color: #4b5563;">
														Hi ${username}, welcome back! Your account has been successfully recovered and is now active. You can log in at any time.
													</td>
												</tr>
														...
														<table border="0" cellspacing="0" cellpadding="0">
															<tr>
																<td align="center" style="border-radius: 8px;" bgcolor="#111827">
																	<a href="${loginPageLink}" target="_blank" style="font-size: 18px; font-family: Arial, sans-serif; color: #ffffff; text-decoration: none; border-radius: 8px; padding: 15px 25px; border: 1px solid #111827; display: inline-block; font-weight: bold;">Back to Login</a>
																</td>
															</tr>
														</table>
													</td>
