                ...
                <div className="w-full max-w-4xl mx-auto">
                    ...
                    <header className="mb-8">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                            <div>
                                <h1 className="text-3xl font-bold text-black">{discipline && discipline.name}</h1>
                                <p className="mt-1 text-gray-600">These are the tasks for your discipline.</p>
                            </div>
                            <Link href={`/disciplines/${discipline && discipline._id}/tasks/create`} className="mt-4 sm:mt-0 w-full sm:w-auto inline-flex items-center justify-center px-5 py-3 rounded-lg bg-black text-white font-semibold hover:bg-gray-800 transition-colors">
