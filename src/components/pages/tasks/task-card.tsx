        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 hover:shadow-md hover:border-black transition-all duration-300">
            <div className="p-6">
                ...
                <div className="mt-6 border-t border-gray-100 pt-4 flex items-center justify-end space-x-2">
                    <Link href={`/disciplines/${disciplineId}/tasks/${task._id}/edit`} className="inline-flex items-center justify-center px-4 py-2 rounded-lg bg-gray-100 text-gray-700 font-semibold text-sm hover:bg-gray-200 hover:text-black transition-colors">
